      ...
      <section className="max-w-[1200px] mx-auto text-white px-5">
        <div className="grid md:grid-cols-3 py-5">
          ...
          <div className="py-8 px-4">
            <h1 className="txt-xl smÇtext-3xl font-bold smÇtext-left text-justify mg-b">
              Be Ready to Grow
            </h1>
            <p>
            ...
            <div className="flex items-center h-10">
              <input
                type="text"
                className="py-1 px-3 w-full h-[100%] inline-block focus:outline-none focus:border-sky-500
                            focus:ring-2 focus:ring-sky-500 bg-gray-800 border-gray-200 border-2"
                placeholder="Email"
              />
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <HiLocationMarker />
                  <p>Noida, Uttar Pradessh</p>
                </div>
                <div className="flex items-center gap-3 mt-3">
                  <MdMessage />
                  <p>pdrothefreits@gmail.com</p>
                </div>
                <div className="flex items-center gap-3 mt-3">
                  <MdCall />
                  <p>+11 941509022</p>
        ...
        <div className="hidden sm:block">
            <div>
                <span className="text-sm text-gray-400">
                    copyright &copy; 2024 by PedroFodao
                </span>
